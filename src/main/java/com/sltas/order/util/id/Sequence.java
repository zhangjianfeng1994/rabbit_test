...
public class Sequence {
    ...
    public Sequence() {
        ...
        logger.info("初始化 IdWorker workerId : {} ",workerId);
    	logger.info("初始化 IdWorker datacenterId : {} ",datacenterId);
    }
    ...
    public long getTimestamp(long nextId) {
    	return (nextId >> timestampLeftShift) + twepoch;
    }
