...
public class OrderHeader implements Serializable {
     ...
     * 订单号
     */
    @TableField("read_trans_no")
    private String readTransNo;
    ...
    /**
     * 子项流水关联子项主键  例:{"B20170623134432106801":"230101201706231542591000000061","B20170623134806111583":"230101201706231542591000000062"}
     */
     ...
     * 第三方人员编号
     */
    @TableField("thrid_user_code")
    private String thridUserCode;
     ...
     * 冲正退票表主键
     */
    @TableField("refund_invoice_reverse_id")
    private Long refundInvoiceReverseId;

    /**
     * 冲正历史表主键
     */
    @TableField("reversal_log_id")
